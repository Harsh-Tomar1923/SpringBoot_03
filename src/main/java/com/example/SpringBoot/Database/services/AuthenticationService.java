...
import com.example.SpringBoot.Database.repositories.UserRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationService(UserRepository userRepository, EmailServices emailService, JwtTokenService jwtTokenService) {
